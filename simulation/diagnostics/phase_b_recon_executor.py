...
COMPATIBLE_EXECUTOR_HASHES = frozenset({'9232896ff76e5971360819e951c6323f1d474f021e27eed4772956222e0ccc12'})
...
def main(argv=None):
    ...
    versions = manifest.setdefault("executor_versions", [manifest["executor_sha256_lf"]])
