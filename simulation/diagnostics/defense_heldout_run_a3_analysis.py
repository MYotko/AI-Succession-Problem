...
import defense_heldout_run_a3_executor as ex
...
def report_complete(results,runs):
    lines=['# Held-out attacks, attempt 3','',
       ...
       'Attempt 2 halted before any model step on an incorrect scheduler upper seed bound. Attempt 3 corrects it to 1835087820.','']
...
def main():
    if '--halt' in sys.argv:
        ...
        lines=['# Held-out attacks, attempt 3: halt','',
               'This is gate 2 of the promotion plan. The attacks were specified before any run.',
