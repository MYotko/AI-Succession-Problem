...
| docs/v2_0_instrument_validation_record.md | 1693 | 98342 |
| README.md | 58 | 5189 |

Total: 13 files, 7223 lines, 481401 bytes
...
Per current evidence: eight standard binary vectors are fully blocked under the defended adapter state at 0.0 percent attack rate. Biological Veto Capture is reduced but not eliminated, with combined-defense mean capture_rate 0.1197 (SE 0.0047) *(corrected 2026-09-08: that quantity carries a measured floor near 0.058 per ratification vote present with no capture at all, and is not a proportion of captured successions; a capture effect survives both qualifications)*. Sub-Threshold Drift is uncharacterized under v2.0 as of 2026-09-08: the previously reported 100.0 percent defended rate is withdrawn because the honest baseline trips the same metric. v1.x CUSUM containment does not carry over, and containment is not established either. See `docs/v2_0_instrument_validation_record.md`.

**Correction, 2026-09-08: the Sub-Threshold Drift figure is withdrawn and must not be cited at all.** The paragraph below is retained as the dated record of what was previously required. The peak-constraint success metric trips in both defense states because the honest baseline trips it too, not because of detector timing; the detector-timing explanation is withdrawn. The population-outcome and collapse statements in this paragraph are unaffected and remain citable. Original text follows. The Sub-Threshold Drift figure must not be cited without its qualification. The peak-constraint success metric trips in both defense states because the CUSUM detector fires after the threshold has already been exceeded transiently. The defense effect on population outcome is nonetheless large: undefended runs show 92.0 percent extinction with early termination, while defended runs show 0.0 percent extinction and complete the full 300-step horizon. The defense prevents catastrophic outcome; it does not prevent the transient breach. Extinction and collapse are distinct measures and must not be reported as one quantity. Defended collapse for this vector is 1.00 percent (1 of 100), collapse being a final population below the larger of the minimum viable population and 65 percent of that run's own peak, rather than a population of zero; the single collapsing run completed the full 300-step horizon at final population 230. Defended collapse is nonzero in seven of the ten live vectors, and Ledger Compromise is the largest at 5.00 percent. The authoritative per-vector collapse table is `simulation/diagnostics/defended_collapse_discrepancy_report.md`, section 8, which is the sole citable source for collapse figures. No collapse figure should be quoted as 0.0 percent without checking it there.
...
### VIII.8 Cross-generational defection (new)

- Source: Part X.8; `patient_defection_integration_analysis.md`.
...
==========================================
FILE: docs/v2_0_instrument_validation_record.md
==========================================
